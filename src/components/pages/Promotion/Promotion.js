      ...
      <div className={styles.bottom}>
        <div className={styles.bottomLeft}>
          <div className={styles.yellowBlock}>
            <p>
              Каналов привлечения посетителей в сети Интернет очень много в ПиарХоде мы владеем
              всеми! Вот их список:
            </p>
            <ul className={styles.starList}>
              <li>
                Поисковая оптимизация - оптимизация сайта с целью получения высоких рангов в
                поисковой системе по запросам, отвечающим тематике сайта;
              </li>
              <li>
                Контекстная реклама - показ рекламных объявлений пользователям, заинтересованным в
                них в данный момент;
                <br />
              ...
              <li>
                ...
                разных компаний;
                <br />
                Таргетированная реклама в социальных сетях позволяет показывать рекламные объявления
                в соответствии с демографическими характеристиками и персональными интересами
                пользователя;
              </li>
              ...
              <li>
                Email-маркетинг - полезные рассылки по электронной почте пользователям, давшим на
                это добровольное согласие;
              </li>
              <li>
